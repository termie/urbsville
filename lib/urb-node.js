...
var SocketIoServerTransport = function (port, server, options) {
...
extend(SocketIoServerTransport.prototype, {
  ...
  onClientDisconnect: function (socketIoClient) {
    var clientId = this.getClientId(socketIoClient);
    urb.ServerTransport.prototype.onClientDisconnect.call(this, socketIoClient)
