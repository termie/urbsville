...
//>>excludeEnd("webkitMobile");
	...
	// Defined as a property of the global scope to allow for sandboxing.
	...
	var d = this.dojo, dojo = this.dojo;

	//Need placeholders for dijit and dojox for scoping code.
	if(typeof this.dijit == "undefined"){
		var dijit = this.dijit = {_scopeName: "dijit"};
	}
	if(typeof this.dojox == "undefined"){
		var dojox = this.dojox = {_scopeName: "dojox"};
	}
...
=====*/
	...
	/* Begin Node Boilerplate */
	dojo.provide = function () {};
	dojo.require = function () {};
	for (var k in dojo) {
	  exports[k] = dojo[k];
	}
	/* End Node Boilerplate */
//>>excludeStart("webkitMobile", kwArgs.webkitMobile);
}).call(this);
//>>excludeEnd("webkitMobile");
// vim:ai:ts=4:noet
